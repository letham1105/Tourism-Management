...
<head>
    ...
    /* Cải tiến giao diện container */
.container1 {
    padding: 30px 15px;
    margin: 0 auto;
    background: #ffffff; /* Màu nền trắng cho sự sáng sủa */
    box-shadow: 0 4px 20px rgba(0, 0, 0, 0.1); /* Tạo hiệu ứng đổ bóng nhẹ */
    border-radius: 10px; /* Bo góc mềm mại */
    max-width: 1200px; /* Giới hạn chiều rộng để dễ căn chỉnh */
}
...
.container1:hover {
    ...
    transition: all 0.3s ease-in-out; /* Thời gian chuyển đổi mượt mà */
}

/* Thêm phần trang trí góc container */
/* Thêm phần trang trí góc container với gradient xanh lá */
.container1::before {
    content: "";
    position: absolute;
    top: -10px;
    ...
    width: 50px;
    height: 50px;
    background: linear-gradient(45deg, rgba(34, 193, 195, 0.5), rgba(253, 187, 45, 0.5)); /* Gradient xanh lá */
    border-radius: 50%;
    z-index: -1;
                ...
                <div class="about-us-container1">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h5>About Tourism Management System</h5>
                            <p>
