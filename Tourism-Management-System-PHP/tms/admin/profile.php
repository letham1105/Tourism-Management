								...
								if ($query->rowCount() > 0) {
									foreach ($results as $result) { ?>
										...
										<div class="form-group">
											<label class="col-md-2 control-label"><i class="fa fa-user"></i> User Name</label>
											<div class="col-md-8">
										...
										<div class="form-group">
											<label class="col-md-2 control-label"><i class="fa fa-id-card"></i> Name</label>
											<div class="col-md-8">
												<div class="input-group">
													<span class="input-group-addon">
														<i class="fa fa-key"></i>
										...
										<div class="form-group">
											<label class="col-md-2 control-label"><i class="fa fa-envelope"></i> Email</label>
											<div class="col-md-8">
												<div class="input-group">
													<span class="input-group-addon">
														<i class="fa fa-key"></i>
										...
										<div class="form-group">
											<label class="col-md-2 control-label"><i class="fa fa-phone"></i> Mobile No</label>
											<div class="col-md-8">
												<div class="input-group">
													<span class="input-group-addon">
														<i class="fa fa-key"></i>
