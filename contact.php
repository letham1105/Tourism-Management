...
<body>
    ...
    <div class="top-header">
        ...
        <div class="banner-1 " style="background-image: url('./images/n2.png'); background-size: cover; background-position: center; height: 400px; display: flex; align-items: center; justify-content: center;">>
            <div class=" container">
                ...
                <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-top: 20px;">
                    ...
                    <div style="flex: 1; margin-left: 20px;">
                        <form name="contact" method="post" style="border: 1px solid #ccc; padding: 20px; border-radius: 8px; background-color: #f9f9f9; max-width: 400px; margin: auto;">
                            <p>
                                <label for="fname" style="text-align: left; display: block;"><b>Your Name</b></label>
                            ...
                            <p>
                                <label for="email" style="text-align: left; display: block;"><b>Email</b></label>
                            ...
                            <p>
                                <label for="message" style="text-align: left; display: block;"><b>Message</b></label>
